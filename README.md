...
|        |                                                                                           |                                                                                                                                                                                                                           |
| ------ | ----------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 김금란 | <img src="https://avatars.githubusercontent.com/u/31915107?v=4" alt="김금란" width="100"> | <ul><li>메인 플레이리스트 피드 목록 조회</li><li>플레이리스트 구독과 좋아요 기능 구현</li><li>반응형 레이아웃 구현</li><li>프로젝트 구조, lint, 디자인 토큰 등의 설정</li></ul>                                           |
| 양명규 | <img src="https://avatars.githubusercontent.com/u/50770004?v=4" alt="양명규" width="100"> | <ul><li>로그인, 로그아웃, 회원가입 등 인증 처리</li><li>유저 관심사 선택 기능 구현</li><li>플레이리스트 생성/수정 기능 구현</li><li>플레이리스트 재생 및 상세페이지 구현</li><li>firebase 설정 및 유틸함수 생성</li></ul> |
| 이민태 | <img src="https://avatars.githubusercontent.com/u/92559779?v=4" alt="이민태" width="100"> | <ul><li>사용자 정보 수정 기능 구현</li><li>플레이리스트 검색 기능 구현</li><li>생성 내역, 구독 내역 조회 기능 구현</li><li>무한 스크롤 기능 구현</li><li>공용 컴포넌트 개발</li></ul>                                     |
